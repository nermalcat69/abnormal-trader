...
import { logger, defineNuxtModule, resolveAlias, createResolver, extendViteConfig, addPlugin, addComponentsDir, addServerHandler, addPrerenderRoutes, installModule } from '@nuxt/kit';
